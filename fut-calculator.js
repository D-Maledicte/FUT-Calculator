...
const tresholds = [
    {name: 'Rango 10',puntos: 4,recompensa: '500 puntos FC, 1 Sobre De Mezcla De Jugadores Únicos y 1 Elección de jugador FUT Champions (intransferible)',},
    {name: 'Rango 9',puntos: 12,recompensa: '500 puntos FC, 5.000 monedas FUT, 2 sobres Oro Jumbo Premium, 1 Sobre De Jugadores Top De Oro y 1 Elección de jugador FUT Champions (intransferible)',},
    {name: 'Rango 8',puntos: 24,recompensa: '750 puntos FC, 10.000 monedas FUT, 2 sobres Oro Jumbo Premium, 1 Megasobre, 1 Sobre De Jugadores Top De Oro y 2 Elección de jugador FUT Champions (intransferible)',},
    {name: 'Rango 7',puntos: 36,recompensa: '750 puntos FC, 15.000 monedas FUT, 1 Sobre De Jugadores Únicos, 1 Sobre Jumbo De Jugadores Únicos, 2 elecciones de jugadores FUT Champions (intransferibles)',},
    {name: 'Rango 6',puntos: 45,recompensa: '1.000 puntos FC, 25.000 monedas FUT, 1 Sobre TOTW Premium, 1 Sobre De Jugadores Únicos, 1 Sobre Ultimate, 2 elecciones de jugadores FUT Champions (intransferibles)',},
    {name: 'Rango 5',puntos: 51,recompensa: '1.250 puntos FC, 30.000 monedas FUT, 1 Sobre TOTW Premium, 1 Sobre De Jugadores Únicos, 1 Sobre Ultimate, 3 elecciones de jugadores FUT Champions (intransferibles)',},
    {name: 'Rango 4',puntos: 60,recompensa: '1.250 puntos FC, 50.000 monedas FUT, 1 Sobre TOTW Premium, 1 Sobre Jumbo De Jugadores Únicos, 1 Sobre Ultimate, 3 elecciones de jugadores FUT Champions (intransferibles)',},
    ...
    {name: 'Rango 1',puntos: 76,recompensa: '1.250 puntos FC, 100.000 monedas FUT, 3 Sobres TOTW Premium, 1 Sobre De Jugadores Únicos, 2 Sobres Ultimate, 3 elecciones de jugadores FUT Champions (intransferibles)',}
]
